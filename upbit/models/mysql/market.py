...
class MarketInfo(Base):
    ...
    market_warning = Column(VARCHAR(10), comment="시장 경고, ['NONE', 'CAUTION'] 중 하나")
    is_use = Column(CHAR(1), nullable=False, comment="사용 여부, ['Y', 'N'] 중 하나")
    updated_at = Column(DateTime, nullable=False, comment="업데이트 시각")
    deleted_at = Column(DateTime, comment="삭제 시각")
